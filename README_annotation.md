...
## 1. Building pairwise alignments to reference (chains)
pipeline can be found [here]()


## 2. Identifying orthologs with TOGA
pipeline can be found [here]()
...
## 4. Making protein data alignments
...
## 5. Running *de novo* gene prediction with Augustus
### 5.1. Augustus single
...
## 6. Filtering *de novo* predictions with blast
### Filter out repeats
...
## 7. Generating consensus gene models
...
## 8. Adding high-confidence predictions back
...
## 9. Prediction of UTRs from transcriptome data
```
...
## 10. Assessing gene annotation completeness
